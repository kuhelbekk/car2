...
public class bgAnimate extends Image {
	...
	public bgAnimate(AnimationDrawable drawableStart, AnimationDrawable drawableActivate , String sn, int waiting, Stage stage, int x, int y, int z) {		
		super(drawableStart);
		//snd = s;		
